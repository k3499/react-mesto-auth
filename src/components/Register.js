    ...
    <section className="form">
      ...
      <form className="form__form" onSubmit={handleSubmit}>
        <div className="form__input-box">
          <input type="email" placeholder="Email" onChange={handleChangeEmail} className="form__input form__input_email" />
          <input type="password" placeholder="Пароль" onChange={handleChangePass} className="form__input form__input_pass" />
        </div>
